#!/bin/bash --login
#$ -N micros
#$ -o /mnt/iusers01/nactem01/u14498jv/scratch/n2c2_track1/context/bert_baseline_logs/avg_micro_f1_node1_output.txt
#$ -e /mnt/iusers01/nactem01/u14498jv/scratch/n2c2_track1/context/bert_baseline_logs/avg_micro_f1_node1_error.txt
...
# Action
## bluebert/mdl/n2c2action_i2b2event/version_1 retuned to avg_micro_f1
model=bluebert/mdl/n2c2action_i2b2event/version_1
run_micro "$model"

## bluebert/action_entity_marker/version_1/ retuned to avg_micro_f1
model=bluebert/action_entity_marker/version_1/
run_micro "$model"

# Actor
## bert/actor_entity_marked/version_1/ retuned to avg_micro_f1
model=bert/actor_entity_marked/version_1/
run_micro "$model"

# Certainty
## clinical_bert/mdl/n2c2cert_i2b2cert/version_2/ retuned to avg_micro_f1
model=clinical_bert/mdl/n2c2cert_i2b2cert/version_2/
run_micro "$model"
