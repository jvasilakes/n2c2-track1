...
This is the official evaluation script from the N2C2 2022 shared task

Nhung: I added more output for my NER models though
...
def evaluate(corpora, mode='strict', verbose=False):
    ...
    print('{:20}  {:-^22}    {:-^22}   {:-^22}    {:-^22}'.format('', ' strict ', ' lenient ', ' strict ', ' lenient '))
    print('{:20}  {:6}  {:6}  {:6}    {:6}  {:6}  {:6}   {:6}  {:6}  {:6}  {:6}  {:6}  {:6}'.format('', 'Prec.',
                                                                'Rec.',
                                                                'F(b=1)',
                                                                'Prec.',
                                                                'Rec.',
    ...
    for tag in ['Drug']:
        ...
        print('{:>20}  {:<5.4f}  {:<5.4f}  {:<5.4f}    {:<5.4f}  {:<5.4f}  {:<5.4f}  {:<5.0f}  {:<5.0f}  {:<5.0f}    {:<5.0f}  {:<5.0f}  {:<5.0f}'.format(
            tag.capitalize(),
